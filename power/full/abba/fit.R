### fit.R --- 
## Filename: fit.R
## Description: Fit power (canopy and elevation) to hh transect abbas
## Author: Noah Peart
## Created: Wed Mar  4 12:52:06 2015 (-0500)
## Last-Updated: Tue Mar 31 15:39:58 2015 (-0400)
##           By: Noah Peart
######################################################################
source("~/work/hh/power/full/model.R")                               # model/fit functions
...
base_dir <- "~/work/hh/power/full/abba/"
yrs <- c(99, 11)
spec <- c("abba")
